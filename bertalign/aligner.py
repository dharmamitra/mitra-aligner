...
class Bertalign:
    def __init__(self,
        ...
        if win > src_num or win > tgt_num:
            win = min(src_num, tgt_num) -1 
        ...
        #char_ratio = 0.68
        print("Character ratio: {:.2f}".format(char_ratio))
    ...
    def align_sents(self):
        ...
        first_alignment_types = get_alignment_types(2) # 0-1, 1-0, 1-1, orig value = 2
